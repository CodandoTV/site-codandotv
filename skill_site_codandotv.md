...
- Utilitários: `assets/js/util/` — Funções auxiliares
  ...
  - `langs_section_handler.js` — Renderização de tags de linguagem (Android, iOS, Flutter, KMP, CMP, Gradle, Dart, Detekt)
...
- Dados em `speech_content_data.js`: array com `{ youtubeUrl, youtubeTitle, youtubeDescription, youtubeCategories: [] }`
...
4. **#creators (odd-section)** — 3 creators em grid com avatares (120px) e fallback de iniciais
...
| Sigla | Nome | Arquivo | Role | LinkedIn |
|-------|------|---------|------|----------|
| JM | Junior Martins | `assets/images/junior.jpg` | Engenheiro Mobile | `https://www.linkedin.com/in/jrmartins/` |
| GM | Gabriel Moro | `assets/images/moro.jpg` | Engenheiro Mobile | `https://www.linkedin.com/in/gabrielbronzattimoro15031994/` |
| PA | Pedro Alvarez | `assets/images/pedro.jpg` | Engenheiro Mobile | `https://www.linkedin.com/in/pedro-alvarez94/` |
...
| Tab | Título | Lang | Mídia | Multirepo |
|-----|--------|------|-------|-----------|
| 0 | CraftD | Android/iOS/Flutter/CMP | `assets/images/libs/CraftD.mp4` (video autoplay) | Não |
| 1 | Popcorn Guineapig | Gradle, Detekt | `assets/images/libs/popcorn-guineapig.png` | Sim — `popcorn-guineapig` + `popcorn-guineapig-detekt-rule` |
| 2 | eagle-eye | Dart | `assets/images/libs/eagle-eye.png` | Não |
| 3 | jujubaSVG | Kotlin | `assets/images/libs/jujubaSVG.png` | Não |
| 4 | Netflix | Kotlin | `assets/images/libs/Netflix.png` | Sim — `Netflix-Android` + `Netflix-KMP` |

O campo `video: true` no array `data[]` controla se renderiza `<video>` ou `<img>` na aba.

O campo `multirepo: []` (array de objetos `{name, stars, url}`) substitui o antigo booleano `netflix`. Qualquer lib pode ter múltiplos repositórios associados, renderizados dinamicamente como cards com botão "Ver no GitHub".
...
| 4 | `O9g7RX6OrRI` | Kotzilla no Compose Multiplatform: Setup Completo | CMP, Observabilidade |
...
| `tag-observabilidade` | Roxo escuro `#6d28d9` | Observabilidade |
| `tag-cmp` | Roxo `#7c3aed` | Compose Multiplatform |
| `tag-testes` | Verde `#059669` | Testes |
| `tag-testing` | Verde `#059669` | Testing |
...
| Card | Mídia | Links |
|------|-------|-------|
| WhatsApp & Discord | `assets/images/comunidade.png` | WhatsApp: `https://chat.whatsapp.com/BA3c4f1zJifCN9k1c4YaFj` / Discord: `https://discord.gg/uRnBmUGTCu` |
...
| Discord | `https://discord.gg/uRnBmUGTCu` |
  ...
  return [
    {
      ...
      languages: ["Android", "iOS", "Flutter", "CMP"],
    ...
    },
    {
      ...
      description: "Um plugin leve para...",
      languages: ["Gradle", "Detekt"],
      media: "assets/images/libs/popcorn-guineapig.png",
      video: false,
      multirepo: [
        { name: "popcorn-guineapig", stars: "22", url: "https://github.com/CodandoTV/popcorn-guineapig" },
        { name: "popcorn-guineapig-detekt-rule", stars: "1", url: "https://github.com/CodandoTV/popcorn-guineapig-detekt-rule" }
      ]
    },
    // ... 5 abas total
  ]
  ...
  return [
    {
      ...
      youtubeTitle: "Como Entrar em TI: Guia Completo",
      youtubeDescription: "Neste vídeo...",
      youtubeCategories: ["Carreira"]
    },
    { youtubeUrl: "https://www.youtube.com/embed/syEhtDfAbBM", youtubeTitle: "8 Estágios de IA", youtubeCategories: ["IA"] },
    // ... 6 vídeos total
  ]
}
```
...
2. Edite `assets/js/data/library_content_data.js`:
   ```javascript
   {
     ...
     multirepo: [  // opcional: se houver múltiplos repositórios
       { name: "repo-name", stars: "10", url: "https://github.com/CodandoTV/repo-name" }
     ]
   }
   ```
...
Centralizado. 3 creators em grid com avatares (120px) com borda azul e fallback de iniciais coloridas se imagem não carregar.
